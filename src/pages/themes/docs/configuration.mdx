 ...
 */
export default {
  projectLink: 'https://github.com/tecklens',
  titleSuffix: ' – Wolfx Docs',
  footerText: `MIT ${new Date().getFullYear()} © WOLFX.`
  // ... other theme options
}
```
 ...
 */
export default {
  footerText: ({ locale }) => <>MIT ${new Date().getFullYear()} © WOLFX.</>
}
```
...
export default {
  logo: ({ locale }) => (
    <>
      <span className="mr-2 hidden font-extrabold md:inline">WOLFX</span>
...
export default {
  head: ({ locale, title, config, meta }) => (
    <>
      ...
      <meta property="og:title" content="WOLFX: the next docs builder" />
      <meta property="og:description" content="WOLFX: the next docs builder" />
      <meta name="apple-mobile-web-app-title" content="WOLFX" />
    </>
  )
}
```
