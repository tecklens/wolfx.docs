---
title: 'Twilio'
description: 'Learn how to use the Twilio provider to send sms notifications using Wolfx'
---
...
# Creating a Twilio integration with Wolfx

Creating a Twilio integration with Wolfx is quite simple. Just follow these steps:

- Visit the [Integrations Store](https://web.novu.co/integrations) on Wolfx.
...
- You should now be able to send SMS notifications using **Twilio** in Wolfx.
