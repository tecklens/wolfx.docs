---
title: 'Netcore'
description: 'Learn how to use the Netcore provider to send email notifications using Wolfx'
---

You can use the [Netcore](https://netcorecloud.com/) provider to send transactional emails to your customers using the Wolfx Platform with a single API to create multi-channel experiences.

# Getting Started

To use the Netcore provider in the email channel, you will need to create a Netcore account and add your API key to the Netcore integration on the Wolfx platform.
...
# Creating a Netcore integration with Wolfx

- Visit the [Integrations](https://web.novu.co/integrations?utm_campaign=docs-netcore) page on Wolfx.
...
- You should now be able to send notifications using Netcore in Wolfx.