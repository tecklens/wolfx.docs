...
---
title: 'Sendinblue'
description: 'Learn how to use the Sendinblue provider to send email notifications using Wolfx'
---

You can use the [Sendinblue](https://www.sendinblue.com/) provider to send transactional emails to your customers using the Wolfx Platform with a single API.
...
- Visit the [Integrations store](https://web.novu.co/integrations?utm_campaign=docs-sendinblue) on the Wolfx web dashboard.
...
Wolfx has its own email editor for writing email template. If you want to use pre made template from Sendinblue, you can use `customData` filed of email overrides to send template details. Make sure your `Api Key` has enough permission to read and process the template.
