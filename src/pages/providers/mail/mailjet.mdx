---
title: 'Mailjet'
description: 'Learn how to use the Mailjet provider to send email notifications using Wolfx'
---

You can use the [Mailjet](https://mailjet.com/) provider to send transactional emails to your customers using the Wolfx Platform with a single API.
...
- Visit the [Integrations](https://web.novu.co/integrations?utm_campaign=docs-mailjet) page on Wolfx.
