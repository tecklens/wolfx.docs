---
title: 'Mailtrap'
description: 'Learn how to use the Mailtrap provider to send email notifications using Wolfx'
---

You can use the [Mailtrap](https://mailtrap.io/email-sending/) provider to send transactional emails to your customers using the Wolfx Platform with a single API to create multi-channel experiences.

# Getting Started

To use the Mailtrap provider in the email channel, you will need to create a Mailtrap account and add your API key to the Mailtrap integration on the Wolfx platform.
...
# Creating a Mailtrap integration with Wolfx

- Visit the [Integrations store](https://web.novu.co/integrations?utm_campaign=docs-mailtrap) on the Wolfx web dashboard.
...
- You should now be able to send notifications through Mailtrap using Wolfx.