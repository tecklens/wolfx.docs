---
title: 'Postmark'
description: 'Learn how to use the Postmark provider to send email notifications using Wolfx'
---

It is possible to use [Postmark](https://postmarkapp.com/) as a provider to send transactional emails to your customers using the Wolfx Platform with a single API.

# Getting Started

The first step to use the Postmark provider in the email channel is to create a Postmark account and add the personal API key to the Postmark integration on the Wolfx platform.
...
# Create a Postmark integration with Wolfx

- Visit the [Integrations](https://web.novu.co/integrations?utm_campaign=docs-postmark) page on Wolfx.
...
- Now is possible to send notifications using Postmark in Wolfx.